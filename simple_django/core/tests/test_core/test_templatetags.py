...
class UrlTagsTestCase(TestCase):
    """
    Test the url_tags module in simple_django.core.templatetags package.
    """
...
class PaginationTagsTestCase(TestCase):
    """Test the pagination_tags module in the simple_django.core.templatetags
    package.
    """
...
class UsefulFiltersTestCase(TestCase):
    """
    Test the usefil_filters module in the simple_django.core.templatetags package.
    """
